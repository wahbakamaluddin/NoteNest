            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mb-5">
                        ...
                        <!-- Pills Navigation -->
                        <ul class="nav nav-pills mb-4" role="tablist" style="margin-bottom: 20px;">
                            <li class="nav-item">
                                <a class="nav-link active" id="view-notes-tab" data-toggle="pill" href="#view-notes" role="tab"
                                    aria-controls="view-notes" aria-selected="true" style="margin-right: 10px;">View Notes</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="upload-notes-tab" data-toggle="pill" href="#upload-notes" role="tab"
                                    aria-controls="upload-notes" aria-selected="false">Upload Notes</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            <!-- View Notes Tab -->
                            <div class="tab-pane fade show active" id="view-notes" role="tabpanel" aria-labelledby="view-notes-tab">
						...
						%>
                            ...
                            <div class="tab-pane fade" id="upload-notes" role="tabpanel" aria-labelledby="upload-notes-tab" style="color: #364d59;">
    <form action="addNote" method="post" enctype="multipart/form-data">
        <!-- Note Title -->
        <div class="form-group" style="margin-bottom: 10px;">
            <label for="noteTitle">Note Title:</label>
