...
<style>
    .site-footer {
        background-color: #343a40; /* Dark grey background for better contrast */
        ...
        <div class="row text-center">
            <div class="col-md-12">
                <div class="border-top">
                    <p>&copy; <script>document.write(new Date().getFullYear());</script> NoteNest. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
